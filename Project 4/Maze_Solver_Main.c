...
void turnRight(){
	// physical robot
	setMotorTarget(leftWheel,-195, turningSpeed); // Around 355 deg wheel rotation = 90 deg bot turn
	setMotorTarget(rightWheel,195,turningSpeed);
...
void turnLeft(){
	// physical robot
	setMotorTarget(leftWheel,200, turningSpeed); // Around 355 deg wheel rotation = 90 deg bot turn
	setMotorTarget(rightWheel,-200,turningSpeed);
